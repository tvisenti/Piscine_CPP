...
/*   Updated: 2017/04/11 16:10:48 by tvisenti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::FormIsNotSigned::FormIsNotSigned(const FormIsNotSigned& src) {
	*this = src;
	return;
}
...
Form::FormIsNotSigned&	Form::FormIsNotSigned::operator=(const FormIsNotSigned& rhs) {
	(void)rhs;
	return *this;
}
...
std::ostream&	operator<<(std::ostream& o, const Form& rhs) {
	o << rhs.getName() << ", form grade signed " << rhs.getGradeSign() << ", form grade executed " << rhs.getGradeExec() << ", signed " << rhs.getSigned() << std::endl;
	return o;
}
